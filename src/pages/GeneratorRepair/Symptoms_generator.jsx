    ...
    <div className="container sr-symptoms__inner">
      ...
      <div className="sr_syptoms_box">
          ...
          <p className="sr-symptoms__text_serv">
            Наши мастера выполнят ремонт генераторов на грузовую, легковую и сельхозтехнику импортного и отечественного производства <br/>в Омске.
          </p>
        </div>
...
export default Symptoms_generator
