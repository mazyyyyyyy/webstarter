const STEPS = [
  {
    ...
    label: 'Измерение напряжения, которое выдает генератор вашего автомобиля.',
  },
  {
    num: '2',
    icon: (
    ...
    label: 'снять агрегат и проверить его на стенде',
  },
  {
    num: '3',
    icon: (
    ...
    label: 'делаем калькуляцию ремонта генератора с учетом стоимости запчастей',
  },
  {
    num: '4',
    icon: (
    ...
    label: 'Детали, необходимые для ремонта вашего агрегата есть у нас в наличии',
  },
  {
    num: '5',
    icon: (
    ...
    label: 'При завершении ремонта в обязательном порядке производится выходной контроль генератора на стенде',
  },
]

const Diagnostics_generator = () => (
...
export default Diagnostics_generator