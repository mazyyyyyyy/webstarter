const FEATURES = [
  {
    ...
    title: <>Диагностика</>,
    desc:  'Оперативно отдефектуем ваш турбокомпрессор и найдем причину неисправности',
  },
  {
    icon: (
      <img
    ...
    title: 'Ремонт вашего турбокомпрессора от 4-х часов',
  ...
  },
  {
    ...
    title: 'Проверка на калибровочном стенде',
    desc:  'Все турбокомпрессора проходят контроль и калибровку на стендах Европейского производства',
  },
  {
    icon: (
      <img
