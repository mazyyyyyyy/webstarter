const STEPS = [
  {
    ...
    label: 'Делаем входящую диагностику автомобиля',
  },
  {
    num: '2',
    icon: (
    ...
    label: 'ОПРЕДЕЛЯЕМ ПРИЧИНУ НЕИСПРАВНОСТИ СИСТЕМЫ',
  },
  {
    num: '3',
    icon: (
    ...
    label: 'делаем калькуляцию ремонта АВТОКОНДИЦИОНЕРА с учетом стоимости запчастей',
  },
  {
    num: '4',
    icon: (
    ...
    label: 'у нас большой склад запчастей , недостоющие запчасти можем заказать',
  },
  {
    num: '5',
    icon: (
    ...
    label: 'При завершении ремонта в обязательном порядке производится выходной контроль систем кондиционера на стенде',
  },
]

const Diagnostics_condit = () => (
...
export default Diagnostics_condit